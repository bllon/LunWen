        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo U('./upload_lunwenBook');?>">上传论文</a></li>
                <li class="breadcrumb-item active" aria-current="page">上传论文缩编</li>
              </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">新增论文缩编</h4>
                  <p class="card-description">
                		请上传合法论文
                  </p>
                  <form id="myupload" class="forms-sample" action="<?php echo U('./upload_lunwenBook');?>" method="post" enctype="multipart/form-data">
                  	
	                  
                    <div class="form-group">
                      <label class="text-danger">上传论文缩编封面</label>
