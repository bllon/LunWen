        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">管理员申请列表</h4>
                  ...
                  <table class="table table-dark">
                    ...
                    <tbody>
	                    <?php if($registerlist): if(is_array($registerlist)): foreach($registerlist as $key=>$register): ?><tr>
		                        <td>
		                          <?php echo ($register["register_id"]); ?>
		                        </td>
		                        <td>
		                          <?php echo ($register["register_username"]); ?>
		                        </td>
		                        <td>
		                          <?php echo ($register["register_phone"]); ?>
		                        </td>
		                        <td>
		                          <?php echo ($register["register_time"]); ?>
		                        </td>
		                        <?php if($register["statu"] == 0): ?><td class="text-light">未审核</td>
		                      	<?php else: ?>
		                      			<td class="text-primary">已审核</td><?php endif; ?>
		                        <td>
		                        	<?php if($register["statu"] == 0): ?><a class="btn btn-primary btn-sm" href="<?php echo U('./vet',array('id'=>$register['register_id']));?>">审核</a><?php endif; ?>
		                      		<a class="btn btn-danger btn-sm" href="<?php echo U('./del',array('id'=>$register['register_id']));?>">删除</a>
		                        </td>
					...
					<nav aria-label="Page navigation" style="margin-top:40px;">
					  <ul class="pagination pull-right">
					    <li>
					      <a class="btn btn-sm btn-dark" href="<?php echo U('./apply_list',array('to'=>'prev','page'=>$current));?>" aria-label="Previous">
					        <span aria-hidden="true">&laquo;</span>
					      </a>
					    </li>
				    	<?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li><a  class="btn btn-sm btn-danger" href="<?php echo U('./apply_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
								<?php else: ?>
									<li><a  class="btn btn-sm btn-dark" href="<?php echo U('./apply_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
					    	<li>
					      	<a  class="btn btn-sm btn-dark" href="<?php echo U('./apply_list',array('to'=>'next','page'=>$current));?>" aria-label="Next">
        ...
        <?php else: ?>
					<tr>
						<td class="text-center" colspan="8">
							<strong class="text-danger text-center">无申请记录</strong>
						</td>
					</tr><?php endif; ?>
				</tbody>
				</table>
