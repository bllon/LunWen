          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">上传论文相关文档</li>
              </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">新增论文相关文档</h4>
                  <p class="card-description">
                		请上传合法文档
                  </p>
                  <form id="myupload" class="forms-sample" action="<?php echo U('./upload_word');?>" method="post" enctype="multipart/form-data">
                  	
                    
                    <div class="form-group">
                      <label for="word_type">文档类型</label>
                      <input type="text" class="form-control bg-secondary" name="word_type" id="word_type" placeholder="输入文档标题类型">
                    </div>   
	                  
                    <div class="form-group" id="imgFile">
	                    <label for="image">上传文档图片('按顺序添加')</label>
					        		<div id="picInput">
									        <input type="file" name="myfile[]" class="text-dark btn btn-block btn-sm btn-primary" style="margin-bottom:20px;">
									    </div>
                    	<button type="button" id="addBtn" class="btn btn-sm btn-danger" style="margin-bottom:20px;" onclick="addPic1()">继续上传图片</button>  
					    			</div>
                    <!--<div class="form-group">
