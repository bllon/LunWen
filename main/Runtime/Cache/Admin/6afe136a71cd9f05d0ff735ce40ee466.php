      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo U('./lunwen_list');?>">论文管理</a></li>
                <li class="breadcrumb-item active" aria-current="page">论文列表</li>
              </ol>
            </nav>
          </div>
          <div class="row">
                    ...
                    <tbody>
	                    <?php if($lunwenlist): if(is_array($lunwenlist)): foreach($lunwenlist as $key=>$lunwen): ?><tr>
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["lunwen_title"]); ?>
		                      		<?php if($lunwen["lunwen_terms"] == 1): ?><span class="text-danger">(公开)</span><?php endif; ?>
		                        </td>
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["writer"]); ?>
		                        </td>
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["sex"]); ?>
		                        </td>
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["major"]); ?>
		                        </td>
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["rank_type"]); ?>
		                        </td contenteditable="true">
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["lunwen_rank"]); ?>
		                        </td>
		                        <td contenteditable="true">
		                      		<?php echo ($lunwen["biaoji"]); ?>
		                        </td>
		                        <td>
		                        	<?php if($lunwen["lunwen_terms"] == 0): ?><a class="btn btn-primary btn-sm" href="<?php echo U('./giveTerms',array('lunwen_id'=>$lunwen['lunwen_id']));?>">公开</a>
		                        	<?php else: ?>
		                        		<a class="btn btn-warning btn-sm" href="<?php echo U('./recoverTerms',array('lunwen_id'=>$lunwen['lunwen_id']));?>">不公开</a><?php endif; ?>
		                      		<a class="btn btn-danger btn-sm" href="<?php echo U('./delLunwen',array('lunwen_id'=>$lunwen['lunwen_id']));?>">删除</a>
		                        </td>
	                  ...
	                  <nav aria-label="Page navigation" style="margin-top:40px;">
										  <ul class="pagination pull-right">
										    <li>
										      <a class="btn btn-sm btn-dark" href="<?php echo U('./lunwen_list',array('to'=>'prev','page'=>$current));?>" aria-label="Previous">
										        <span aria-hidden="true">&laquo;</span>
										      </a>
										    </li>
									    	<?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li><a  class="btn btn-sm btn-danger" href="<?php echo U('./lunwen_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
												<?php else: ?>
													<li><a  class="btn btn-sm btn-dark" href="<?php echo U('./lunwen_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
										    <li>
										      <a  class="btn btn-sm btn-dark" href="<?php echo U('./lunwen_list',array('to'=>'next','page'=>$current));?>" aria-label="Next">
                  ...
                  <?php else: ?>
												<tr>
													<td class="text-center" colspan="8">
														<strong class="text-danger text-center">无论文记录</strong>
													</td>
												</tr>
											</tbody>
	                  </table><?php endif; ?>
