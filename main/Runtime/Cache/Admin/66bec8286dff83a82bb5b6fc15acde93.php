...
<html>
	<head>
		<meta charset="UTF-8">
		<title></title>
		<link rel="stylesheet" type="text/css" href="/LunWen/main/Public/DropzoneJS/dropzone/basic.css"/>
		<link rel="stylesheet" type="text/css" href="/LunWen/main/Public/DropzoneJS/dropzone/dropzone.css"/>
		<link rel="stylesheet" type="text/css" href="/LunWen/main/Public/DropzoneJS/index.css"/>
	...
	<body>
		...
		<SECTION>
		  <DIV id="dropzone">
		    <FORM class="dropzone needsclick" id="demo-upload" action="<?php echo U(Admin/Index/sendFile);?>" method="post" enctype="multipart/form-data">
	...
	<script src="/LunWen/main/Public/DropzoneJS/jquery.js"></script>
	<script src="/LunWen/main/Public/DropzoneJS/dropzone/dropzone.js"></script>
	<!--<script src="dropzone/dropzone-amd-module.js"></script>-->
	<script src="/LunWen/main/Public/DropzoneJS/index.js"></script>
</html>