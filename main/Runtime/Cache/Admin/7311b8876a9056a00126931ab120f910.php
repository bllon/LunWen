              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-dark">
                    ...
                    <tbody>
	                    <?php if($consumerlist): if(is_array($consumerlist)): foreach($consumerlist as $key=>$consumer): ?><tr>
		                        <td>
		                          <?php echo ($consumer["consumer_id"]); ?>
		                        </td>
		                        <td>
		                          <?php echo ($consumer["consumer_unionid"]); ?>
		                        </td>
		                        <td>
		                          <?php echo ($consumer["borrownum"]); ?> 本
		                        </td>
		                        <td>
		                        	<a class="btn btn-danger btn-sm" href="<?php echo U('./consumer_del',array('id'=>$consumer['consumer_id']));?>">删除</a>
		                        </td>
					...
					<nav aria-label="Page navigation" style="margin-top:40px;">
					  <ul class="pagination pull-right">
					    <li>
					      <a class="btn btn-sm btn-dark" href="<?php echo U('./consumer_list',array('to'=>'prev','page'=>$current));?>" aria-label="Previous">
					        <span aria-hidden="true">&laquo;</span>
					      </a>
					    </li>
				    	<?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li><a  class="btn btn-sm btn-danger" href="<?php echo U('./consumer_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
								<?php else: ?>
									<li><a  class="btn btn-sm btn-dark" href="<?php echo U('./consumer_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
					    	<li>
					      	<a  class="btn btn-sm btn-dark" href="<?php echo U('./consumer_list',array('to'=>'next','page'=>$current));?>" aria-label="Next">
        ...
        <?php else: ?>
					<tr>
						<td class="text-center" colspan="8">
							<strong class="text-danger text-center">无用户记录</strong>
						</td>
					</tr><?php endif; ?>
				</tbody>
				</table>
