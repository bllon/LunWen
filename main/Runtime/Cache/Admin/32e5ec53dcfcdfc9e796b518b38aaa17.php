...
<body>
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo U('./upload_bookImg');?>">上传论文</a></li>
                <li class="breadcrumb-item active" aria-current="page">上传论文缩编内容</li>
              </ol>
            </nav>
          </div>
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">新增论文缩编内容</h4>
                  <p class="card-description">
                		请上传合法论文
                  </p>
                  <form id="myupload" class="forms-sample" action="<?php echo U('./upload_bookImg');?>" method="post" enctype="multipart/form-data">
                  	
                    
                    <div class="form-group">
                      <label for="book_id">上传至</label>
                      <input type="text" class="form-control bg-secondary" name="book_id" id="book_id" value="<?php echo ($book["addtime"]); ?>" disabled="disabled">
                    </div>   
                    ...
                    <div class="form-group" id="imgFile">
	                    ...
	                    <div id="picInput" v-for="n in uploadNum">
					        ...
					        <input type="file" name="myfile[]" class="text-dark btn btn-block btn-sm btn-info" style="margin-bottom:20px;">  
					    </div>
                    </div>
                    <!--<div class="form-group">
  ...
  <script src="/LunWen/main/Public/js/upload_bookimg.js"></script>
