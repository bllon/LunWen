      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo U('./history');?>">论文管理</a></li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-dark">
                    ...
                    <tbody>
	                    <?php if($historylist): if(is_array($historylist)): foreach($historylist as $key=>$history): ?><tr>
		                        <td>
		                          <?php echo ($history["history_id"]); ?>
		                        </td>
		                        <td>
		                      		<?php echo ($history["consumer_unionid"]); ?>
		                        </td>
		                        <td>
		                      		<?php echo ($history["lunwenid"]); ?>
		                        </td>
		                        <td>
		                      		<?php echo ($history["phone"]); ?>
		                        </td>
		                        <td class="text-primary">
		                      		<?php echo ($history["action"]); ?>
		                        </td>
		                        <td class="text-secondary">
		                      		<?php echo ($history["actiontime"]); ?>
		                        </td>
	                    ...
	                    <nav aria-label="Page navigation" style="margin-top:40px;">
						  <ul class="pagination pull-right">
						    <li>
						      <a class="btn btn-sm btn-dark" href="<?php echo U('./history',array('to'=>'prev','page'=>$current));?>" aria-label="Previous">
						        <span aria-hidden="true">&laquo;</span>
						      </a>
						    </li>
					    	<?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li><a  class="btn btn-sm btn-danger" href="<?php echo U('./history',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
								<?php else: ?>
									<li><a  class="btn btn-sm btn-dark" href="<?php echo U('./history',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
						    <li>
						      <a  class="btn btn-sm btn-dark" href="<?php echo U('./history',array('to'=>'next','page'=>$current));?>" aria-label="Next">
                  ...
                  <?php else: ?>
					<tr>
						<td class="text-center" colspan="8">
							<strong class="text-danger text-center">暂无历史记录</strong>
						</td>
					</tr>
					</tbody>
	        		</table><?php endif; ?>
