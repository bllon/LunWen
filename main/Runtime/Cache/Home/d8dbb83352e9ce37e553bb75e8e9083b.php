...
<!-- Stylesheets -->
<link rel="stylesheet" href="/LunWen/main/Public/css/font-awesome.min.css">
<link rel="stylesheet" href="/LunWen/main/Public/css/bootstrap.min.css">
<link rel="stylesheet" href="/LunWen/main/Public/css/bootstrap-theme.min.css">
<!-- color css -->
<link rel="stylesheet" href="/LunWen/main/Public/switcher/switcher.css" />
<link rel="stylesheet" href="/LunWen/main/Public/css/main.css">
<link rel="stylesheet" href="/LunWen/main/Public/css/colors/blue.css">
<script src="/LunWen/main/Public/home-js/modernizr-2.8.3-respond-1.4.2.min.js"></script>
<style type="text/css">
...
<section id="slides" class="pb">
	<div class="slides-container">
		<div class="slide active">
			<div class="img"><img src="/LunWen/main/Public/images/slider/slide1.jpg" alt="slide" class="img-responsive"></div>
		...
		<!-- end slide1 -->
		<div class="slide">
			<div class="img"><img src="/LunWen/main/Public/images/slider/slide2.jpg" alt="slide" class="img-responsive"></div>
			<div class="overlay"></div>
			<div class="slide-caption">
				<div class="container">
					<div class="box">
	...
	<div class="container">
		<div class="row">
			...
			<div class="pricing-table">
				<div class="col-md-5">
					<form action="<?php echo U('Home/Apply/apply');?>" method="post" class="form">
...
<section id="karbar-footer-section">
	<div class="row">
		<div class="col-sm-12 col-md-12">
			...
			<div class="contact-form clearfix">
				<form method="post" action="<?php echo U('Home/Apply/send');?>" class="" id="ajax-contact">
					<div class="col-sm-6">
						<div class="input-text">
							<input type="text" name="name" id="name" class="input-name form-control" placeholder="Full name" >
						</div>
						<div class="input-email">
							<input type="email" name="email" id="email" class="input-email form-control" placeholder="Email" >
						</div>
						<div class="input-phone">
							<input type="text" name="phone" id="phone" class="input-phone form-control" placeholder="Phone">
						</div>
					</div>
					<div class="col-sm-6">
						...
						<button type="submit" id="submit" name="submit" class="submit-btn">Send Now<i class="icon-paper-plane"></i></button>
					</div>
					<!--Result notification -->
	...
	<div class="bottom">
		<div class="row">
			<div class="col-sm-12">
				<div class="copyright">
					<p class="copyright">Copyright &copy; 2018.<a href="<?php echo U('Home/Apply/index');?>" title="本科论文库">本科论文库</a> - 景德镇陶瓷大学科技艺术学院</p>
				</div>
			</div>
		</div>
	</div>
...
<script src="/LunWen/main/Public/home-js/jquery-1.8.3.min.js"></script>
<!-- plugin js -->
<script src="/LunWen/main/Public/home-js/plugins.js"></script>
<!-- super slider -->
<script type="text/javascript" src="/LunWen/main/Public/home-js/jquery.superslides.min.js"></script>
<!-- contact js -->
<script src="/LunWen/main/Public/home-js/jquery-contact.js"></script>
<!-- retina js -->
<script src="/LunWen/main/Public/home-js/retina.min.js"></script>
<!-- mailchimp -->
<script src="/LunWen/main/Public/home-js/jquery.ajaxchimp.min.js"></script>
<!-- scroll animatin JS -->
<script src="/LunWen/main/Public/home-js/scrollreveal.min.js"></script>
<script src="/LunWen/main/Public/home-js/main.js"></script>
