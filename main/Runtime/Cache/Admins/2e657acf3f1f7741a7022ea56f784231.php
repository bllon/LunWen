...
<html>
				...
				<div class="row">
                        ...
                        <div class="col-sm-5 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo U('./login');?>" method="post" class="registration-form">
			                        ...
			                        <div class="row">
			                        	<div class="col-sm-4 form-group">
				                        	...
				                        	<input type="text" name="yzm" placeholder="验证码" maxlength="4" class="form-control" id="yzm">
				                        </div>
				                        <div class="col-sm-4">
				                        	<img src="<?php echo U('Admins/User/yzm');?>" class="img-responsive" id="yzmImg" title="看不清，换一张"/>
				                        </div>
			                        </div>
	...
	<script>
		$('#yzmImg').click(function(){
			this.src="<?php echo U('Admins/User/yzm');?>";
//			$.get('../Admins/User/yzm',function(data,success){
//				console.log($('#yzmImg').attr);
//				$('#yzmImg').attr('src',data);
//			})
		})
	</script>
</html>