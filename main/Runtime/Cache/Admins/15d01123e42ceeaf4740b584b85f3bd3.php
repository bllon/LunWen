		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">论文汇编管理</h4></li>
				</ul>
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
						        ...
						        <li><a href="<?php echo U('Admins/Data/book_list');?>" class="am-cf text-primary">论文汇编</a></li>
				...
				<div class="card-box">
					...
					<div class="am-g">
						...
						<div class="am-u-sm-12 am-u-md-3">
							<form action="<?php echo U('Admins/Data/book_list');?>" method="post">
				          		<div class="am-input-group am-input-group-sm">
				          			<input type="text" class="am-form-field" id="keyword" name="keyword">
						          	<span class="am-input-group-btn">
						            	<button class="am-btn am-btn-default" id="search" type="submit">搜索</button>
						          	</span>
				          		</div>
				           </form>
				        </div>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              	<?php if($booklist): if(is_array($booklist)): foreach($booklist as $key=>$book): ?><tr>
		                <td class="chooseBtn"><input type="checkbox" value="<?php echo ($book["book_id"]); ?>"/></td>
		                <td><?php echo ($book["book_id"]); ?></td>
		                <td><a href="#"><?php echo ($book["school_name"]); ?></a></td>
		                <td class="am-hide-sm-only"><?php echo ($book["addtime"]); ?></td>
		                <td>
		                  <div class="am-btn-toolbar">
		                    <div class="am-btn-group am-btn-group-xs">
						      <a href="<?php echo U('Admins/Data/book_del',array('id'=>$book['book_id']));?>" class="delBtn am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
            ...
            <div class="am-cf">
              	共 <?php echo ($booknum); ?> 条记录
              <?php if(!$keyword): ?><div class="am-fr">
                <ul class="am-pagination">
                  <li><a href="<?php echo U('Admins/Data/book_list',array('to'=>'prev','page'=>$current));?>">«</a></li>
                  <?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li class="am-active"><a href="<?php echo U('Admins/Data/book_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
					<?php else: ?>
						<li><a href="<?php echo U('Admins/Data/book_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
                  <li><a href="<?php echo U('Admins/Data/book_list',array('to'=>'next','page'=>$current));?>">»</a></li>
                </ul>
              </div><?php endif; ?>
            </div>
