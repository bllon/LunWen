		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">入驻管理</h4></li>
				</ul>
				    ...
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li><a href="<?php echo U('Admins/Apply/apply_list');?>"><span class="am-icon-home text-danger"></span> 入驻管理</a></li>
				...
				<div class="card-box">
					...
					<div class="am-g">
						<div class="am-u-sm-12 am-u-md-6">
				          <div class="am-btn-toolbar">
				            <div class="am-btn-group am-btn-group-xs">
				              <button class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="ajaxApply()"><span class="am-icon-archive"></span> 审核</button>
						...
						<div class="am-u-sm-12 am-u-md-3">
							<form action="<?php echo U('Admins/Apply/apply_list');?>" method="post">
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              	<?php if($applylist): if(is_array($applylist)): foreach($applylist as $key=>$apply): ?><tr>
		                <td class="chooseBtn"><input type="checkbox" value="<?php echo ($apply["apply_id"]); ?>"/></td>
		                <td><?php echo ($apply["apply_id"]); ?></td>
		                <td><a href="#"><?php echo ($apply["apply_school"]); ?></a></td>
		                <td><?php echo ($apply["apply_user"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($apply["apply_phone"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($apply["email"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($apply["apply_phone"]); ?></td>
		                <td>
		                  <div class="am-btn-toolbar">
		                    <div class="am-btn-group am-btn-group-xs">
		                      <?php if($apply["apply_statu"] == 0): ?><a href="<?php echo U('Admins/Apply/apply_finish',array('apply_id'=>$apply['apply_id']));?>" class="applyBtn am-btn am-btn-default am-btn-xs am-text-secondary">
			                      	<span class="am-icon-archive"></span> 审核
			                      </a><?php endif; ?>
						      <a href="<?php echo U('Admins/Apply/apply_del',array('id'=>$apply['apply_id']));?>" class="delBtn am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
            ...
            <div class="am-cf">
              	共 <?php echo ($applynum); ?> 条记录
              <?php if(!$keyword): ?><div class="am-fr">
                <ul class="am-pagination">
                  <li><a href="<?php echo U('Admins/Apply/apply_list',array('to'=>'prev','page'=>$current));?>">«</a></li>
                  <?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li class="am-active"><a href="<?php echo U('Admins/Apply/apply_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
					<?php else: ?>
						<li><a href="<?php echo U('Admins/Apply/apply_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
                  <li><a href="<?php echo U('Admins/Apply/apply_list',array('to'=>'next','page'=>$current));?>">»</a></li>
                </ul>
              </div><?php endif; ?>
            </div>
