		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">论文资源管理</h4></li>
				</ul>
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
						        <li><a href="<?php echo U('Admins/Data/lunwen_list');?>" class="am-cf text-primary"> 论文资源</span></a></li>
				...
				<div class="card-box">
					...
					<div class="am-g">
						...
						<div class="am-u-sm-12 am-u-md-3">
							<form action="<?php echo U('Admins/Data/lunwen_list');?>" method="post">
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tr>
                ...
                <th class="table-author am-hide-sm-only">是否公开</th>
                <th class="table-date am-hide-sm-only">上传日期</th>
                <th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              	<?php if($lunwenlist): if(is_array($lunwenlist)): foreach($lunwenlist as $key=>$lunwen): ?><tr>
		                <td class="chooseBtn"><input type="checkbox" value="<?php echo ($lunwen["lunwen_id"]); ?>"/></td>
		                <td><?php echo ($lunwen["lunwen_id"]); ?></td>
		                <td><a href="#"><?php echo ($lunwen["lunwen_title"]); ?></a></td>
		                <td><?php echo ($lunwen["school_name"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($lunwen["writer"]); ?></td>
		                <?php if($lunwen["lunwen_terms"] == 0): ?><td class="am-hide-sm-only text-light">未公开</td>
		                <?php else: ?>
		                	<td class="am-hide-sm-only text-danger text-warning">公开</td><?php endif; ?>
		                <td class="am-hide-sm-only"><?php echo ($lunwen["addtime"]); ?></td>
		                <td>
		                  <div class="am-btn-toolbar">
		                    <div class="am-btn-group am-btn-group-xs">
						      <a href="<?php echo U('Admins/Data/lunwen_del',array('id'=>$lunwen['lunwen_id']));?>" class="delBtn am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
            ...
            <div class="am-cf">
              	共 <?php echo ($lunwennum); ?> 条记录
              <?php if(!$keyword): ?><div class="am-fr">
                <ul class="am-pagination">
                  <li><a href="<?php echo U('Admins/Data/lunwen_list',array('to'=>'prev','page'=>$current));?>">«</a></li>
                  <?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li class="am-active"><a href="<?php echo U('Admins/Data/lunwen_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
					<?php else: ?>
						<li><a href="<?php echo U('Admins/Data/lunwen_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
                  <li><a href="<?php echo U('Admins/Data/lunwen_list',array('to'=>'next','page'=>$current));?>">»</a></li>
                </ul>
              </div><?php endif; ?>
            </div>
