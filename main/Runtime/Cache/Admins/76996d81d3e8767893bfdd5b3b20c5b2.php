		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">学校管理</h4></li>
				</ul>
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        <li><a href="<?php echo U('Admins/Data/school_list');?>" class="am-cf text-primary"> 学校管理</span></a></li>
				...
				<div class="card-box">
					...
					<div class="am-g">
						...
						<div class="am-u-sm-12 am-u-md-3">
							<form action="<?php echo U('Admins/Data/school_list');?>" method="post">
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <tbody>
              	<?php if($schoollist): if(is_array($schoollist)): foreach($schoollist as $key=>$school): ?><tr>
		                <td class="chooseBtn"><input type="checkbox" value="<?php echo ($school["school_id"]); ?>"/></td>
		                <td><?php echo ($school["school_id"]); ?></td>
		                <td><a href="#"><?php echo ($school["school_name"]); ?></a></td>
		                <td><?php echo ($school["school_admin"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($school["phone"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($school["email"]); ?></td>
		                <td class="am-hide-sm-only"><?php echo ($school["build_time"]); ?></td>
		                <?php if($school["statu"] == 1): ?><td class="text-success">启动</td>
		                <?php else: ?>
		                	<td class="text-danger">关闭</td><?php endif; ?>
		                <td>
		                  <div class="am-btn-toolbar">
		                    <div class="statu am-btn-group am-btn-group-xs" value="<?php echo ($school["school_id"]); ?>">
		                      	<?php if($school["statu"] == 1): ?><!--<?php echo U('Admins/Data/school_close',array('id'=>$school['school_id']));?>-->
			                		<a href="" value="<?php echo ($school["school_id"]); ?>" class="schoolclose am-btn am-btn-default am-btn-xs text-danger am-hide-sm-only">
								      	<span class="am-icon-dot-circle-o"></span> 关闭系统
								     </a>
			                	<?php else: ?>
			                		<a href="" value="<?php echo ($school["school_id"]); ?>" class="schoolstart am-btn am-btn-default am-btn-xs text-success am-hide-sm-only">
								      	<span class="am-icon-dot-circle-o"></span> 启动
								    </a><?php endif; ?>
            ...
            <div class="am-cf">
              	共 <?php echo ($schoolnum); ?> 条记录
              <?php if(!$keyword): ?><div class="am-fr">
                <ul class="am-pagination">
                  <li><a href="<?php echo U('Admins/Data/school_list',array('to'=>'prev','page'=>$current));?>">«</a></li>
                  <?php if(is_array($nav)): foreach($nav as $k=>$page): if($k== $current): ?><li class="am-active"><a href="<?php echo U('Admins/Data/school_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li>
					<?php else: ?>
						<li><a href="<?php echo U('Admins/Data/school_list',array('page'=>$k));?>"><?php echo ($k); ?></a></li><?php endif; endforeach; endif; ?>
                  <li><a href="<?php echo U('Admins/Data/school_list',array('to'=>'next','page'=>$current));?>">»</a></li>
                </ul>
              </div><?php endif; ?>
            </div>
